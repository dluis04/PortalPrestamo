...
import com.portalPrestamos.estandar.vista.utilidades.AccesoPropiedadesVista;
...
public class MBMensajes {
	...
	public void mostrarMensaje(String mensaje, String titulo, int tipoMensaje) {
		try {
			FacesMessage message = new FacesMessage((tipoMensaje == MENSAJE_OK ? FacesMessage.SEVERITY_INFO
					: (tipoMensaje == MENSAJE_ALERTA ? FacesMessage.SEVERITY_WARN : FacesMessage.SEVERITY_ERROR)),
					mensaje, titulo);
	...
	public void mostrarMensaje(BaseException bmBaseException) {
		// Se invoca el metodo encargado de mostrar la ventana con el mensaje de la
		// excepcion.
	...
	/**
	 * Metodo para mostrar un error desde un codigo y una descricion mas amplia del
	 * mismo
	 * 
	 * @param code
	 *            codigo del error
